...
and 3.) main.py: The script with the main code of the program, and two functions;

a.) get_mvp(): responsible for executing SQL queries to retrieve data from the database
b.) main(): serving as the entry point to the program, and it handles user input and output.

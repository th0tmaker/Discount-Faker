...
To use the program, simply provide a text of your choice as a string inside the variable named 'text' and run the program. The output will show the frequency count of each word in the text, with the most frequent words listed first.
